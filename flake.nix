                                                            ...
                                                            pkgs.stdenv.mkDerivation
                                                                {
                                                                    installPhase =
                                                                        let
                                                                            ...
                                                                            observed = builtins.tryEval ( observation ( ( builtins.trace "d963b61b-8bbe-4e78-8b50-164d08768f79" lib ) ( builtins.trace "44439799-bdbf-411e-8507-fe2fb0a434ee" simple ) complex ( builtins.trace "608947e3-3140-4571-8999-a8f6bba1650d" visited ) ) ) ;
                                                                            in
